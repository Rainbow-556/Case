...
public class CountDownListViewActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.aty_countdown_listview);
		...
		lstProducts.add(new Product("R", System.currentTimeMillis() + 40000));
		lstProducts.add(new Product("S", System.currentTimeMillis() + 20000));
		lstProducts.add(new Product("T", System.currentTimeMillis() + 50000));
		lstProducts.add(new Product("U", System.currentTimeMillis() + 60000));
		lstProducts.add(new Product("V", System.currentTimeMillis() + 20000));
		lstProducts.add(new Product("W", System.currentTimeMillis() + 10000));

		lvItems.setAdapter(new CountdownAdapter(CountDownListViewActivity.this,
				lstProducts));
	}
	...
	public class CountdownAdapter extends ArrayAdapter<Product> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				holder.tvProduct = (TextView) convertView
						.findViewById(R.id.tvProduct);
				holder.tvTimeRemaining = (TextView) convertView
						.findViewById(R.id.tvTimeRemaining);
	...
	private class ViewHolder {
		...
		public void updateTimeRemaining(long currentTime) {
			...
			if (timeDiff > 0) {
				...
				tvTimeRemaining.setText(hours + " hrs " + minutes + " mins "
						+ seconds + " sec");
			} else {
